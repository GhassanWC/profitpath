...
class AtlasLoading extends StatelessWidget {
  const AtlasLoading({super.key, this.label, this.compact = false});
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            if (label != null) ...<Widget>[
              ...
              Text(label!, style: AtlasTypography.caption),
            ],
          ],
        ),
      ),
      ...
      child: Column(
        ...
        children: <Widget>[
          Container(
            ...
            child: Icon(icon, color: AtlasColors.inkFaint, size: 24),
          ),
...
class AtlasErrorView extends StatelessWidget {
  const AtlasErrorView({
    required this.error,
    super.key,
    this.onRetry,
    this.compact = false,
...
class SectionHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Padding(
    ...
    child: Row(
      children: <Widget>[
        Expanded(
          child: Text(label.toUpperCase(), style: AtlasTypography.overline),
        ),
        ?trailing,
      ],
    ),
