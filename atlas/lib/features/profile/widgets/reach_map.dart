...
///
/// The most Atlas-specific thing on a profile: on other networks a creator's
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: outlines == null
              ? const ColoredBox(color: AtlasColors.ocean)
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        Text('${entry.value}', style: AtlasTypography.overline),
                      ],
                    ),
                  ),
              ],
