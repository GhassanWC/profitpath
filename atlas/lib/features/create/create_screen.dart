  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(state.step.title, style: AtlasTypography.title),
        ...
        children: <Widget>[
          ...
          if (isReview)
            TextButton(
              ...
              child: Text('Save as a draft', style: AtlasTypography.caption),
            ),
        ],
      ),
    );
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text('It is on its way', style: AtlasTypography.headline),
