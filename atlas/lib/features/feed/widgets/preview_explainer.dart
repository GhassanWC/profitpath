      ...
      builder: (BuildContext context) => SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              Text('About AI previews', style: AtlasTypography.headline),
...
class _Point extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Padding(
    ...
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
        Text(title, style: AtlasTypography.titleSmall),
        const SizedBox(height: 4),
        Text(body, style: AtlasTypography.caption.copyWith(height: 1.5)),
      ],
    ),
  );
}
