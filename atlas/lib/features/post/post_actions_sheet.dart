        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            for (final ReportReason reason in ReportReason.values)
              ListTile(
                title: Text(reason.label, style: AtlasTypography.body),
...
class _ActionTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) => ListTile(
    onTap: onTap,
    leading: Icon(icon, color: danger ? AtlasColors.danger : AtlasColors.ink),
    title: Text(
      label,
      style: AtlasTypography.body.copyWith(
        color: danger ? AtlasColors.danger : AtlasColors.ink,
      ),
    ),
    subtitle: Text(detail, style: AtlasTypography.caption),
  );
}
