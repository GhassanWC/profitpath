...
class _CommentsSheetState extends ConsumerState<_CommentsSheet> {
  ...
  Future<void> _send() async {
    ...
    try {
      ...
      if (mounted) setState(() => _error = AtlasErrorView.messageFor(error));
    } finally {
        ...
        child: Column(
          children: <Widget>[
            Padding(
              ...
              child: Row(
                children: <Widget>[
                  Text('Comments', style: AtlasTypography.title),
        ...
        Expanded(
          child: Column(
            ...
            children: <Widget>[
              ...
              Text(
                comment.body,
                style: AtlasTypography.bodyMuted.copyWith(fontSize: 14),
              ),
            ],
          ),
        ),
