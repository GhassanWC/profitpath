...
/// `AtlasException` subclasses and nothing else.
...
abstract interface class UserRepository {
  Future<AtlasUser> byId(String id);

  Future<AtlasUser?> byUsername(String username);
  ...
  Future<AtlasUser> update(AtlasUser user);
