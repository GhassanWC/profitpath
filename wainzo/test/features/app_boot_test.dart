import 'package:wainzo/app.dart';
import 'package:wainzo/core/widgets/wainzo_button.dart';
import 'package:wainzo/features/feed/widgets/ai_preview_card.dart';
import 'package:wainzo/features/map/widgets/world_map.dart';
...
void main() {
  Future<void> boot(WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      ProviderScope(overrides: testOverrides(), child: const WainzoApp()),
    );
  ...
  testWidgets('opens on sign-in and says what the product is', (
    ...
    expect(find.text('Wainzo'), findsOneWidget);
    expect(
  ...
  testWidgets('a post can be written, targeted and published', (
    ...
    final WainzoButton publish = tester.widget<WainzoButton>(
      find.widgetWithText(WainzoButton, 'Publish'),
    );
    expect(
      publish.onPressed,
      isNotNull,
