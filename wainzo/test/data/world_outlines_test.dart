import 'package:wainzo/core/geo/projection.dart';
import 'package:wainzo/data/geo/country_registry.dart';
import 'package:wainzo/data/geo/world_outlines.dart';
...
void main() {
  ...
  test('refuses something that is not an Wainzo map asset', () {
    expect(
      () => WorldOutlines.parse(
