...
final class MockBackend {
  MockBackend({
    ...
    for (final WainzoUser user in MockData.creators) {
      users[user.id] = user;
    }
  ...
  static const String _profileKeyPrefix = 'wainzo.interest.';
  ...
  final Map<String, WainzoUser> users = <String, WainzoUser>{};
