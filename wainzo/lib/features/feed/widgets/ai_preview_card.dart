                  ...
                  return Column(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        ...
                        style: WainzoTypography.headline,
                      ),
                      const SizedBox(height: Insets.md),
                      Flexible(
                      ...
                      if (preview != null) ...<Widget>[
                        ...
                        Flexible(
                          child: _ElasticText(
                            ...
                            style: WainzoTypography.body.copyWith(height: 1.45),
                          ),
                        ),
                      ],
                      const Spacer(),
                        ...
                        children: <Widget>[
                          Expanded(
                            ...
                            child: WainzoButton(
                              ...
                              size: veryTight
                                  ? WainzoButtonSize.small
                                  : tight
                                  ? WainzoButtonSize.medium
                                  : WainzoButtonSize.large,
                              expand: true,
                              semanticLabel:
...
class _Backdrop extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final AsyncValue<WainzoUser> creator = ref.watch(
...
class _GlassPill extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    decoration: BoxDecoration(
      color: WainzoColors.ground.withValues(alpha: 0.62),
