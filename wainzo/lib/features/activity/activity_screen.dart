            ...
            child: Row(
              children: <Widget>[
                ...
                TextButton(
                  ...
                  child: Text('Mark all read', style: WainzoTypography.caption),
                ),
              ],
            ),
          ),
...
class _NotificationTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final (IconData icon, Color colour) = switch (notification.kind) {
      NotificationKind.reach => (Icons.public_rounded, WainzoColors.accent),
      ...
      NotificationKind.shared => (Icons.ios_share_rounded, WainzoColors.ink),
    ...
    return Material(
      color: notification.read ? Colors.transparent : WainzoColors.accentSoft,
      child: InkWell(
        onTap: onTap,
        child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    if (notification.body.isNotEmpty) ...<Widget>[
                      ...
                      Text(notification.body, style: WainzoTypography.caption),
                    ],
                  ],
                ),
              ),
