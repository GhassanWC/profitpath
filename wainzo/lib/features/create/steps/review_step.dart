      ...
      child: AnimatedBuilder(
        ...
        builder: (BuildContext context, _) {
          ...
          return Column(
            ...
            children: <Widget>[
              Text('Analysing your post', style: WainzoTypography.headline),
              const SizedBox(height: Insets.xl),
    ...
    child: WainzoCard(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Text(
            'Previews on Wainzo explain what a post is. These need rewording:',
          ...
          for (final String flag in flags)
            Text(
              '· $flag',
              style: WainzoTypography.caption.copyWith(color: WainzoColors.ink),
            ),
        ],
      ),
    ),
      ...
      child: Padding(
        ...
        child: Row(
          children: <Widget>[
            SizedBox(
              width: 108,
              child: Text(label, style: WainzoTypography.caption),
            ),
            if (dot != null) ...<Widget>[
              Container(
                width: 6,
            ...
            Expanded(child: Text(value, style: WainzoTypography.body)),
            if (onTap != null)
              const Icon(
    ...
    child: SingleChildScrollView(
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: <Widget>[
            Text('Edit the preview', style: WainzoTypography.headline),
            const SizedBox(height: Insets.sm),
            Text(
...
class _LabelledField extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Padding(
    ...
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
        Text(label.toUpperCase(), style: WainzoTypography.overline),
        const SizedBox(height: Insets.sm),
        TextField(
