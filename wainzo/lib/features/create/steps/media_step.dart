...
class _MediaOption extends StatelessWidget {
  ...
  Widget build(BuildContext context) => WainzoCard(
    onTap: onTap,
    color: selected ? WainzoColors.surfaceHigh : WainzoColors.surface,
    border: selected ? WainzoColors.accentEdge : WainzoColors.hairline,
    child: wide
        ? Row(
            children: <Widget>[
              Icon(icon, color: WainzoColors.accent, size: 22),
              const SizedBox(width: Insets.lg),
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    Text(label, style: WainzoTypography.titleSmall),
                    if (detail != null)
                      Text(detail!, style: WainzoTypography.caption),
                  ],
                ),
              ),
            ],
      ...
      children: <Widget>[
        Container(
          ...
          decoration: BoxDecoration(
            color: WainzoColors.surfaceHigh,
