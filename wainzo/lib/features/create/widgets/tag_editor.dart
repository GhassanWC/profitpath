...
class _TagEditorState extends State<TagEditor> {
  ...
  Widget build(BuildContext context) => Column(
    ...
    children: <Widget>[
      Text(widget.label.toUpperCase(), style: WainzoTypography.overline),
    ...
    child: Column(
      ...
      children: <Widget>[
        Padding(
          ...
          child: Text(title, style: WainzoTypography.title),
        ),
        Flexible(
          child: ListView(
            shrinkWrap: true,
            children: <Widget>[
              for (final T option in options)
                ListTile(
                  ...
                  title: Text(labelOf(option), style: WainzoTypography.body),
