...
final class MockAuthService implements AuthService {
  MockAuthService({SharedPreferencesAsync? preferences, WainzoUser? seedUser})
    : _preferences = preferences ?? SharedPreferencesAsync(),
      _seedUser = seedUser;

  static const String _storageKey = 'wainzo.session';

  final SharedPreferencesAsync _preferences;
  final WainzoUser? _seedUser;
  ...
  Future<AuthSession> signInWithEmail({
    ...
    final WainzoUser user = _seedUser ?? _userFromEmail(email);
  ...
  Future<AuthSession> registerWithEmail({
    ...
    final WainzoUser user = WainzoUser(
  ...
  Future<AuthSession> signInWithGoogle() async {
    ...
    return _establish(
      _seedUser ??
          WainzoUser(
            id: 'u_google_demo',
            username: 'wainzo.explorer',
            displayName: 'Wainzo Explorer',
            createdAt: DateTime.now(),
          ),
      AuthProvider.google,
    );
  ...
  Future<void> updateUser(WainzoUser user) async {
  ...
  Future<AuthSession> _establish(WainzoUser user, AuthProvider provider) async {
  ...
  WainzoUser _userFromEmail(String email) {
