...
class WainzoCard extends StatelessWidget {
  const WainzoCard({
    required this.child,
    super.key,
    this.padding = const EdgeInsets.all(Insets.lg),
    this.radius = Radii.lg,
    this.color = WainzoColors.surface,
    this.border = WainzoColors.hairline,
    this.onTap,
    this.clip = false,
  });
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      ...
      child: InkWell(
        onTap: onTap,
        borderRadius: BorderRadius.circular(radius),
        splashColor: WainzoColors.accentSoft,
        highlightColor: WainzoColors.accentSoft,
        child: body,
      ),
    );
  }
